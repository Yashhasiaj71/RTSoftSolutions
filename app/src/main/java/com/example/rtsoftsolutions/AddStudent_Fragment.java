...
public class AddStudent_Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        submitbutton = currentactivity.findViewById(R.id.savedetails);
    ...
    public boolean putdata(String name, String email, String phone, String address, String aadhar, String fathername, String mothername, String tpa) {
         if()
    }
